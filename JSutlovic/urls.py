...
urlpatterns = patterns(
    ...
    url(r'^resume/plain$', 'resume', {"plain": True},
        name='jsutlovic-resume-plain'),
    url(r'resume/(?P<name>\S+)/plain$', 'resume', {"plain": True},
        name='jsutlovic-resume-name-plain'),
    url(r'^resume/(?P<name>\S+)$', 'resume', name='jsutlovic-resume-name'),
    url(r'^work$', 'projects', name='jsutlovic-projects'),
    url(r'^work/tech/(?P<techtag>\S+)$', 'projects', {"name": None},
        name='jsutlovic-projects-techtag'),
...
urlpatterns += patterns(
    ...
    #Favicon
    url(r'^favicon\.ico$',
        RedirectView.as_view(url='/static/images/favicon16.ico')),
